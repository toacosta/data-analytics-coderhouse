...
CREATE TABLE Inventario(
	id_producto int PRIMARY KEY, -- INT para almacenar identificadores �nicos.
	nombre_producto varchar(100), -- VARCHAR(100) permite guardar nombres de distinta longitud.
	categoria varchar(50), -- VARCHAR porque la categor�a es texto.
	precio_unitario decimal(10, 2), -- DECIMAL evita errores de precisi�n en valores monetarios.
	stock_actual int, -- INT almacena cantidades enteras.
	stock_minimo int,
	fecha_ingreso date, -- DATE guarda �nicamente la fecha.
...
VALUES
(1, 'Laptop Pro 15', 'Computaci�n', 1200.00, 15, 3, '2024-01-10', 1),
(2, 'Mouse Inal�mbrico', 'Accesorios', 28.00, 80, 10, '2024-01-10', 1),
(3, 'Monitor 4K 27"', 'Computaci�n', 450.00, 12, 2, '2024-01-15', 1),
(4, 'Teclado Mec�nico', 'Accesorios', 95.00, 40, 5, '2024-01-15', 1),
(5, 'Laptop Basic 14', 'Computaci�n', 650.00, 20, 3, '2024-02-01', 1),
